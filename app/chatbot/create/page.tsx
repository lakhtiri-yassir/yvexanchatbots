...
import { DesignExportDialog } from "@/components/ui/design-export-dialog";
import { DesignImportDialog } from "@/components/ui/design-import-dialog";
...
export default function CreateChatbotPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    available_models: MODEL_PROVIDERS.reduce(
      (acc, provider) => ({
        ...acc,
                ...
                <Card className="shadow-sm border-0 bg-white">
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <FileUpload
                      ...
                      userId={user?.id || ""}
                      onUpload={(url) =>
                        handleInputChange("bot_avatar_url", url)
                      }
                      maxSize={5}
                    />
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          handleInputChange("starting_phrase", e.target.value)
                        }
                        ...
                        <Popover>
                          ...
                          <PopoverContent className="w-auto p-0">
                            <Calendar
                              ...
                              onSelect={(date) =>
                                date &&
                                handleInputChange("last_payment_date", date)
                              }
                              initialFocus
                            />
                          </PopoverContent>
                      ...
                      <div className="flex items-center space-x-2">
                        <Switch
                          ...
                          onCheckedChange={(checked) =>
                            handleInputChange("auto_model_selection", checked)
                          }
                        />
                        <Label className="text-sm font-medium">
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="grid grid-cols-2 gap-3">
                            {[
                              ...
                              >
                                <Checkbox
                                  checked={formData.fallback_models.includes(
                                    model,
                                  )}
                                  onCheckedChange={(checked) => {
                                    const newFallbacks = checked
                                      ? [...formData.fallback_models, model]
                                      : formData.fallback_models.filter(
                                          (m) => m !== model,
                                        );
                                    handleInputChange(
                                      "fallback_models",
              ...
              <div id="knowledge" className="space-y-8 pt-8">
                ...
                <Card className="shadow-sm border-0 bg-white">
                  <CardHeader className="pb-4">
                    ...
                    <CardDescription>
                      Upload documents to give your chatbot access to specific
                      information
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">
                      ...
                      <p className="text-gray-600 mb-4">
                        Click to upload or drag and drop PDF, TXT, DOCX files
                        only
                      </p>
                      <Button
                        type="button"
                      ...
                      <div className="space-y-4">
                        <div className="flex items-center space-x-2">
                          <Switch
                            ...
                            onCheckedChange={(checked) =>
                              handleInputChange("voice_enabled", checked)
                            }
                          />
                          <Label className="text-sm font-medium">
                            Voice Integration
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="flex items-center space-x-2">
                        <Switch
                          ...
                          onCheckedChange={(checked) =>
                            handleInputChange("data_capture_enabled", checked)
                          }
                        />
                        <Label className="text-sm font-medium">
                          Lead Capture
                      ...
                      <div className="flex items-center space-x-2">
                        <Switch
                          ...
                          onCheckedChange={(checked) =>
                            handleInputChange("footer_branding", checked)
                          }
                        />
                        <Label className="text-sm font-medium">
            ...
            <Card className="shadow-sm border-0 bg-white">
              ...
              <CardContent className="space-y-3">
                <button
                  ...
                  className="w-full flex items-center justify-center space-x-2 px-4 py-2 bg-indigo-50 hover:bg-indigo-100 text-indigo-700 rounded-lg font-medium transition-colors"
                >
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center space-x-2 px-4 py-2 bg-blue-50 hover:bg-blue-100 text-blue-700 rounded-lg font-medium transition-colors"
                >
